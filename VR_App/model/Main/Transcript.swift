...
//        TranscriptModel(title: "Web application tools", description: "I would be a first billionaire", date:"02/06/2021"),
//        TranscriptModel(title: "ASR technology", description: "Automated speech recognition is any technology that allows a computer to convert spoken language into typed text in real time", date:"09/04/2021"),
//        TranscriptModel(title: "Voice recognition App", description: "Wise Quotes Before you perish, it's significant for your hereafter to leave behind or to give to the world your wisdom, experience, and knowledge, for humanity thrives on the past, present and to forecast the future.", date:"06/12/2021"),
...
//        TranscriptModel(title: "📌IOS Articles", description: "ios Development https://sarunw.com/posts/", date:"18/02/2021"),
    ]
