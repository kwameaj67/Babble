...
struct Swipe{
    ...
    static let swipeData:[Swipe] = [
        Swipe(image: UIImage(named: "Voice control-bro")!, title: "Why use Babble?", description: "Babble is extremely valuable to anyone who needs to generate a lot of written content without manual typing"),
